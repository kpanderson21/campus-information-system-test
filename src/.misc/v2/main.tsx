...
function PageContent({ pathname }: { pathname: string }) {
    ...
    switch (pathname) {
        ...
        case '/department/college-of-nursing':
            ContentComponent = () => <>College Of Nursing Page<br/>
            college Of Nursing Page<br/>
            college Of Nursing Page<br/>
            college Of Nursing Page<br/>
            college Of Nursing Page<br/>
            college Of Nursing Page<br/>
...
// Main component with localStorage integration
export default function SimpleDashboardLayout() {
    const [pathname, setPathname] = React.useState(() => {
        // Read initial pathname from localStorage
        return localStorage.getItem('pathname') || '/dashboard';
    });

    // Update localStorage whenever pathname changes
    React.useEffect(() => {
